...
typedef int (*flash_open)(uint8_t id, const struct flash_area **);

void flash_area_close(const struct flash_area *);
typedef void (*flash_close)(const struct flash_area *);
...
int flash_area_read(const struct flash_area *, uint32_t off, void *dst,
                    uint32_t len);
typedef int (*flash_read)(const struct flash_area *, uint32_t off, void *dst,
                    uint32_t len);

int flash_area_write(const struct flash_area *, uint32_t off, const void *src,
                     uint32_t len);
typedef int (*flash_write)(const struct flash_area *, uint32_t off, const void *src,
                     uint32_t len);

int flash_area_erase(const struct flash_area *, uint32_t off, uint32_t len);
typedef int (*flash_erase)(const struct flash_area *, uint32_t off, uint32_t len);
...
typedef int (*flash_get_sectors)(int fa_id, uint32_t *count,
                           struct flash_sector *sectors);
