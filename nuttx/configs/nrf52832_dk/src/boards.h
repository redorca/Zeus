...
#include "pca10036.h"
#elif defined(BOARD_PCA10040) || defined(CONFIG_ARCH_BOARD_NRF52832_DK)
//#include "pca10040.h"
#include <arch/board/pca10040.h>
#elif defined(BOARD_PCA10056) || defined(CONFIG_ARCH_BOARD_NRF52840_DK)
#include <arch/board/pca10056.h>
 ...
 *
 * Description:
 *   Initialize the pcm510x device on the board.
 *
 * Input Parameters:
 *
 * Returned Value:
 ...
 *
 * Description:
 *   Initialize and register the bmm150 magnetometer device driver.
 *
 * Input Parameters:
 *
 * Returned Value:
 ...
 *
 * Description:
 *   Initialize and register the mc3672 accelerater device driver.
 *
 * Input Parameters:
 *
 * Returned Value:
