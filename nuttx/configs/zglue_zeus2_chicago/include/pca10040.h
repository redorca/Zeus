...
/* indicate there is bootloader for system:
 * So there are two image from internal flash, /dev/mtdblock1
 * always as second image device for upgrading
 */
#define SYSTEM_BOOTLOADER_IMAGE_SIZE (64*UNIT_1K)   /* assume system bootloader size */
#define SYSTEM_APP_IMAGE_SIZE  CONFIG_MCUBOOT_APP_IMAGE_MAX_SIZE
#else
#define SYSTEM_BOOTLOADER_IMAGE_SIZE (0*UNIT_1K)   /* assume system bootloader size */
