...
{
  pm_peer_id_t
  peer_id; /**< The peer this event pertains to, if previously bonded. @ref PM_PEER_ID_INVALID if no successful bonding has happened with the peer before. */
...
#if defined(SECURITY_DISPLATCH_MODULE_NEEDS_THIS)
