...
#if defined(NRF_BLE_GATT_ENABLED)
...
#else
#define NRF_BLE_GATT_MTU_SIZE_DEFAULT   CONFIG_BLE_GATT_MTU_SIZE_DEFAULT
#endif
...
#endif
  /* warning ============  Should this return be here? */
  //return -1; /* Bill Rees; compiler complained about an empty return */
}
