...
{
  uint16_t
  att_mtu_desired_periph;                //!< Requested ATT_MTU size for the next peripheral link that is established.
  uint16_t
  att_mtu_desired_central;               //!< Requested ATT_MTU size for the next central link that is established.
