...
/**@brief Function set the Peripheral Preferred Connection Parameters.
 *
 * @details Save the parameters to local variable and set it to stack.
 *
 * @param[in]   ppcp  Peripheral Preferred Connection Parameters.
 *
 * @return      NRF_SUCCESS on set successful, otherwise an error code.
 */
uint32_t ble_set_preferred_conn_paramter(ble_gap_conn_params_t   *ppcp);


/**@brief Function for handling connection timeout timer event.
 */
