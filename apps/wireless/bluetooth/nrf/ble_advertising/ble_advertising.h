...
/**@brief Function for seting the adverting mode.
 *
 * @details This function for changing the advertising mode only.
 *
 * @param[in] p_adv_modes_config   The advertising mode parameters.
 *
 * @retval @ref void.
 */
